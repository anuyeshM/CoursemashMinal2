...
/></h1>
                        <p>Make smart friends, learn from experts, and network like you have never done before.</p>
                        <button className='btn btn-primary px-4 py-2 me-2' onClick={()=>{navigateTo(); ClickHandler()}}>Join now!</button>
