        ...
        <div className='row course-container border-bottom my-4'>
            <div className='d-flex align-items-center my-3'>
                ...
                <div className='w-100'>
                    ...
                    <a style={{background: '#1484f5', color:'white',width:'70px', height: '38px',padding:'7px 7px 7px 7px',margin: '2px 2px 2px 2px',font:'400 12px system-ui'}} href={pdf}>Get Free PDF</a>
                </div>
            </div>
        </div>
    );
